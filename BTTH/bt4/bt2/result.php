...
$studentName = trim($_POST['student_name'] ?? 'Ẩn danh');
$submitted = true;
$score = 0;
...
$savedResultId = $questionManager->saveQuizResult($studentName, $totalQuestions, $score);
$resultSaved = ($savedResultId !== null);
...
<div class="quiz-container">
    <div class="result-card">
        ...
        <p class="mb-2"><strong>Học viên:</strong> <?php echo htmlspecialchars($studentName); ?></p>
        ...
        <?php if ($resultSaved): ?>
            <p class="mt-2" style="font-size: 0.9em; opacity: 0.9;">✅ Kết quả đã được lưu vào cơ sở dữ liệu</p>
        <?php else: ?>
            <p class="mt-2" style="font-size: 0.9em; opacity: 0.9;">⚠️ Không thể lưu kết quả vào cơ sở dữ liệu</p>
        <?php endif; ?>
    </div>
...
<?php endforeach; ?>
    ...
    <div class="text-center">
        ...
        <a href="history.php" class="btn btn-outline-secondary btn-lg ms-2">📊 Xem lịch sử</a>
    </div>
</div>
